...
Este ejercicio es un poco más complejo así que te recomiendo que primero veas el código base, luego le preguntes a Lisa lo que necesites para entender la consigna y luego le expliques cómo lo vas a resolver. No te pongas a codear antes de entender la consigna y de tener un plan.
*/
...
const carrito = [
  ...
  console.log("Con $" + montoDisponible + " puedes comprar:", comprables, 'y gastarás $' + totalAGastar);