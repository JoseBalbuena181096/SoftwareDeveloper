...
Cafeterías cercanas
Desafío
En este caso queremos filtrar una collection de cafeterías para quedarnos solo con las más cercanas. Para esto debemos iterar todas las cafeterías y acumular en otro array las que estén a menos de 1 km.

En este caso no vamos a necesitar un indice para recorrer el array de cafés pero si vamos a necesitar un indice extra para ir acumulando cosas en el array cercanas[].
*/
...
for (const c of cafes) {
  ...
  if (c.distance < distanciaMaxima) {
    cercanas[indexCercanas] = c;
    indexCercanas++;
  }
}

console.log("La cafeterías más cercanas son:", cercanas);
